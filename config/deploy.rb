...
set :log_level, :info
set :linked_files, %w{config/secrets.yml config/database.yml config/exception_notification.yml config/cocca-api.yml config/checkout.yml config/sidekiq.yml}
